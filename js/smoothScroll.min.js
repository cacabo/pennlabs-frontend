(function(root, factory) {
  ...
  smoothScroll.animateScroll = function(anchor, toggle, options) {
    ...
    var endLocation = isNum
      ? anchor
      : getEndLocation(anchorElem, headerHeight, parseInt((typeof animateSettings.offset === 'function'
        ? animateSettings.offset()
        : animateSettings.offset), 10)); // Location to scroll to
  ...
  var clickHandler = function(event) {
    ...
    if (!toggle || toggle.tagName.toLowerCase() !== 'a' || getClosest(event.target, settings.ignore))
      return;
